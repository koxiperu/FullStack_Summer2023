...
jQuery(document).ready(function() {
    ...
    if(utmsession!="" && utmsession!='undefined' && utmsession!=undefined){
  ...
  //jQuery('.CodeMirror:before').css('backdrop-filter','none');
		 jQuery('.CodeMirror').append('<style>.CodeMirror:before{content:initial!important;}</style>');
		jQuery('.download-editor').css('display','none');
		 });
});
